...
export async function createVirtualMachine(
	...
	const wizard: AzureWizard<IVirtualMachineWizardContext> = new AzureWizard(
		wizardContext,
	...
	wizardContext.activityTitle = localize(
		...
		nonNullProp(wizardContext, "newVirtualMachineName"),
	);
	...
	const newVm: VirtualMachineTreeItem = new VirtualMachineTreeItem(
		node.subscription,
		virtualMachine,
	);
...
export async function createVirtualMachineAdvanced(
